...
<button class="layui-btn " lay-event="update_fangqi">放弃客户</button>
<button class="layui-btn " lay-event="update_hf">回访</button>
</script>
	<table class='layui-table'
		lay-data="{url:'select_pri?customer_user=${login_username}',toolbar:'#userlist_bar',id:'private',page:true,method:'post'}"
		lay-filter="usertable">
		<thead>
			<tr>
				<th lay-data="{type:'checkbox'}"></th>
				<th lay-data="{field:'customer_id',width:100}">id</th>
				<th lay-data="{field:'customer_name',width:140}">客户</th>
				<th lay-data="{field:'customer_man',width:130}">业务员</th>
				<th lay-data="{field:'customer_tel',width:160}">电话</th>
